...
$(function () {
  ...
  var sources = {
    ...
    "Bing Maps Satellite":
      "http://ecn.t0.tiles.virtualearth.net/tiles/a{quad}.jpeg?g=129&mkt=en&stl=H",
    "Bing Maps Hybrid":
    ...
    "Google Maps Hybrid":
      "https://mt0.google.com/vt?lyrs=h&x={x}&s=&y={y}&z={z}",
    "Google Maps Terrain":
  ...
  function startDrawing() {
    ...
    M.Toast.dismissAll();
    M.toast({
      html: "Click two points on the map to make a rectangle.",
      displayLength: 7000,
    });
  }
